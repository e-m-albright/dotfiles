...
| **Pi** | earendil-works | active | Local-first lightweight terminal agent (shares `~/.agents/skills`); packages `pi-superpowers-plus` + `mitsupi`, vendored presets + deterministic permission policy. See ADR-0005/0006 + [docs/pi-power-setup.md](docs/pi-power-setup.md) |
