...
dotfiles agent prune         # Dry-run: list deployed skills that were ours but are no longer canonical (renamed/removed); --apply to delete. Untracked externals are reported, never auto-deleted
