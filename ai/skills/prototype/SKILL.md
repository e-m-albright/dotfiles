...
metadata:
  ...
  adaptations: Refs (`LOGIC.md`, `UI.md`) moved into `references/`. Description gained literal-phrase triggers. Body otherwise verbatim.
---
...
## Sources
- Adapted from [mattpocock/skills/engineering/prototype](https://github.com/mattpocock/skills/blob/733d312/skills/engineering/prototype/SKILL.md) (ported 2026-05-07, MIT). Refs moved into `references/`.
