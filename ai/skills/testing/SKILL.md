---
name: testing
description: Universal testing taxonomy — cost-aware tiers, pytest markers, test placement, and affectedness-based selection. Use when writing tests for a new feature or bug fix, deciding which tests to run on a change, setting up pytest markers or a tests/ directory layout, structuring evals, or when the user says "add tests", "what should I test", "which tests to run", "how do I mark slow/model tests".
---
