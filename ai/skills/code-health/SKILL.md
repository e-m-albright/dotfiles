...
| whole-repo, measured, ratchet down, reduce LOC, converge over passes | **improve-codebase-architecture** | measured · convergent |
...
5. **legible** — final readability and navigation pass.
6. **improve-codebase-architecture** — measure, ratchet the gains into CI contracts, and re-grade. This is what makes the pass *stick* and *converge* rather than re-rot.
...
## See also
- The measured engine and its references (metrics, ratchet, de-slop catalog, ontology, deepening vocab): [improve-codebase-architecture](../improve-codebase-architecture/SKILL.md).
