...
## Sources
- Authored for this repo (Bash-first dotfiles): enforces the `set -eo pipefail`, quoted-expansion, and idempotency conventions in `CLAUDE.md`. Promoted to the canonical `ai/subagents/` set 2026-06-10.
