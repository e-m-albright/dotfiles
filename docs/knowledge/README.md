# Knowledge — cross-cutting practice & tooling
...
- [repo-standards.md](repo-standards.md) — the opt-in per-repo baseline checklist (lefthook, justfile, AGENTS/README, ratchets, CI, linters) — the cross-repo backbone to the catechism's intra-repo one
...
- **Prompting**
  ...
  - [advisory-personas.md](prompting/advisory-personas.md) — expert advisory system prompts
