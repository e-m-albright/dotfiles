...
- [remote-shell.md](remote-shell.md) - phone-to-laptop access over Tailscale, Mosh, and Zellij
...
- [knowledge-graph-tooling.md](knowledge-graph-tooling.md) - watch on queryable-knowledge-graph tools for agents (Graphify and its landscape), and the practices worth internalizing
- [infrastructure-as-code-landscape.md](infrastructure-as-code-landscape.md) - watch on IaC (Terraform/OpenTofu/Pulumi/Crossplane), Kubernetes, and GitOps (ArgoCD) tooling
