...
|-------|----------|---------------|--------|-------------|
| `diagnose` | [mattpocock/skills/engineering/diagnose](https://github.com/mattpocock/skills/blob/733d312/skills/engineering/diagnose/SKILL.md) | `733d312` | 2026-05-07 | Verbatim port. Cross-references to `/converge` and project glossary/ADRs preserved (resolve when those land). |
...
|------|---------------------|-------------|---------|-------------|
| [mattpocock/skills](https://github.com/mattpocock/skills) | [`733d312`](https://github.com/mattpocock/skills/commit/733d312884b3878a9a9cff693c5886943753a741) | 2026-05-07 | MIT | Process skills (diagnose, grill-with-docs, tdd, converge, prototype). Best-in-class engineering process library — Phase 2 borrows. |
