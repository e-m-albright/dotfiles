...
| Linter/Formatter | **Biome** | ESLint + Prettier (slow, config hell) |
...
| Need | Pick | Notes |
|------|------|-------|
| Desktop app | **Tauri** | Only if you need native distribution |
...
| Monorepo build | **Turborepo** | Candidates: nx (plugin-heavy), moon (Rust-based). Turborepo: simplest, Vercel-maintained |
| Dead code | **Knip** | Finds unused exports, deps, files |
| Component dev | **Histoire** | Storybook alternative, Vite-native |
| Docs site | **Starlight (Astro)** | Best docs DX in ecosystem |
...
| Storybook | Histoire is lighter, Vite-native |
