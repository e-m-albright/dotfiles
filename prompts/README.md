...
Prompt-construction assets — source material for the system prompts and advisor personas we run in web chats and agents. Not deployed into projects.

- `system-prompt-advisor.md`, `system-prompt-detailed.md` — system-prompt sources (loaded to clipboard by `dotfiles agent web-chat-instructions`)
