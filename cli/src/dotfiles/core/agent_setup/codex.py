...
from dotfiles.core.agent_setup.toml_writer import render_mcp_toml, upsert_section
...
def _render_tui_keys(keys: dict[str, object]) -> list[str]:
    ...
    from dotfiles.core.agent_setup.toml_writer import _toml_value  # type: ignore[attr-defined]
