...
Apply when reviewing code for structural quality. Not every item applies to every change — focus on what the diff touches.
...
_Promoted from `.ai/rules/process/code-audit.mdc` into this skill's references._
