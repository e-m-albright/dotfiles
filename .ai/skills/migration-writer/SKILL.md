...
description: Generate database migration files for Goose (Go) or Drizzle (D1) following project conventions, with up/down inverses and auto-detected tooling. Use when user invokes /migration-writer, says "add a migration", "new migration", "alter the schema", "add/drop a column/table/index", or mentions Goose / Drizzle / `goose create` / `drizzle-kit generate`.
